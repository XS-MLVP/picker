...
# run cache codegen
rm -rf temp 
./build/bin/picker export --autobuild=false example/XDummyCache/Cache.sv --sdir ./template/xdut/cpp --tdir ./temp  --sname XDumyCache -tname Cache -w Cache.fst --sim verilator
