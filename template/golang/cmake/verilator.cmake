...
function(XSGolangTarget)
	...
	swig_add_library(UT_${PROJECT_NAME} TYPE SHARED LANGUAGE go SOURCES dut.i)
	...
	if(APPLE)
		...
		target_link_options(UT_${PROJECT_NAME}  PRIVATE "-Wl,-undefined,dynamic_lookup")
	endif ()

	set_target_properties(UT_${PROJECT_NAME} PROPERTIES
			SUFFIX ".so"
			SWIG_COMPILE_OPTIONS "-module;UT_${PROJECT_NAME}"
	)
endfunction()
